...
4. On the console execute the following command
 Update-Database  -Context Library_SystemIdentityDatabaseContext


5. On the console execute the following command
Update-Database  -Context Library_SystemDatabaseContext


6. After migration is successful Run the project 

7 if you click on Books/Members/ Lendings this will redirect you to ASP .net identity login page login from the following credentials
